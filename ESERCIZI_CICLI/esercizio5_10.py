...
user_registrati = ["marmellatAdipere", "adriano12" , "danielinho2202", "frakiller01", "juan"]
...
for user in user_registrati:
    user_registrati_minuscoli.append(user)
for nuovouser in nuovi_user:
    nuovi_user_minuscoli.append(nuovouser)
...
for nuovouser in nuovi_user_minuscoli:
    if nuovouser in user_registrati_minuscoli:
